...
let
    println("Copying animation files:")
    root = dirname(dirname(pathof(SquareDanceReasoning)))
    src = joinpath(root, "test/test_calls/Animations")
    dest = joinpath(root, "docs/src/Animations")
    mkpath(dest)
    ...
    println("Build the animations index file:")
...
makedocs(;
    ...
    pages=[
        ...
        "Square Dance Calls" => [
            ...
            "Animations" => "Animations/index.md",             # autogenerated
            "Choreograpy Showcase" => "Showcase/showcase.md",  # autogenerated
            "Call Examples" => "as_text_examples.md"
        ],
        "Index" => "doc_index.md",
